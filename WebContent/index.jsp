		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				...
				<a  class="navbar-brand"> <small> <i
						class="fa fa-cog"></i> 南京理工大学-光伏远程监控系统
				</small>
				</a>
			</div>
			<div  class="navbar-buttons navbar-header" style="padding-top: 6px;cursor: pointer;margin-left:68%" onclick="creatw();">
			   <img  alt="聊天室" src="${ctx}/images/myChat.png" style="width:30px;height:30px">
			</div>
			<div role="navigation" class="navbar-buttons navbar-header pull-right">
					<a href="${ctx}/logout.shtml" class="navbar-brand"> <small>退出系统
				</small>
				</a>
			</div>
		</div>
