...
<title>登录－光伏远程监控系统</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/login_files/min.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/login_files/login.css">
<link href="${pageContext.request.contextPath}/login_files/css.css"
	...
	<div id="loginbox" style="padding-top: 10%;">
		<form id="loginform" name="loginform" class="form-vertical"
				...
				<table style="width: 100%">
					<tr>
						<td align="left"><img
							...
							alt="Logo"></td>
						<td align="center" style="font-weight: bold; color: white;font-size: 18pt;">登录－光伏远程监控系统</td>
						<td align="right"><img
							src="${pageContext.request.contextPath}/login_files/logo_left.png"
							alt="Logo"></td>
					</tr>
			...
			<div class="form-actions">
				...
				<span class="pull-right"> <button onclick="checkUserForm();" class="btn btn-success">登&nbsp;&nbsp;录</button>
				</span>
			</div>
		</form>
	</div>
