...
public class PagePlugin implements Interceptor {
	...
	public void joinSql( Connection connection, MappedStatement mappedStatement, BoundSql boundSql, Map<String, Object> formMap, List<Object> formMaps){
		try{
			...
			System.out.println("初始化sql出错了:"+e.getMessage());
		}
	}
	public static void setCount(String sql,MappedStatement mappedStatement, Connection connection, BoundSql boundSql,
		...
		try {
			...
			try {
				...
				logger.info(countSql+" 统计Sql出错,自动转换为普通统计Sql语句!");
